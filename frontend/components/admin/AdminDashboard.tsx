  ...
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        <StatCard label="Total colleges" value={String(COLLEGES.length)} delta="+2 this month" up />
        ...
        <StatCard label="Mock tests taken" value={String(testHistory.length + 42)} delta="+12 this week" up />
      </div>
