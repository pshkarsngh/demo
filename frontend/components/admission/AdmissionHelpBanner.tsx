...
export function AdmissionHelpBanner() {
  return (
    <div className="mx-auto max-w-7xl px-4 pb-4 sm:px-6 lg:px-8">
      <div className="flex flex-col items-center justify-between gap-4 rounded-3xl border border-orange-100 bg-gradient-to-r from-orange-50 via-amber-50 to-orange-50 px-6 py-5 sm:flex-row">
        <div className="flex items-center gap-3 text-center sm:text-left">
          ...
          <div>
            <p className="font-bold text-gray-900">Need help choosing the right college?</p>
            <p className="text-sm text-gray-500">Talk to our counsellors — free, expert admission guidance.</p>
          </div>
        </div>
        <Link
          href="/admission"
